...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Cedric De Mits']
  spec.email         = ['cedricdemits@gmail.com']

  spec.summary       = 'A bare-bones gem for making gitlab api requests.'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['changelog_uri'] = 'https://github.com/Ongewitter/gitlabarty/blob/master/README.md'
  else
